...
<body>
    <nav class="navbar navbar-fixed-top navbar-inverse">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin"><strong><span class="white">Chris's</span><span class="blue">Beauty</span></strong></a>
            </div>
    ...
    <footer class="footer navbar-fixed-bottom navbar-inverse">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <p class="text-muted text-center"><strong><span class="white">Chris's</span><span class="blue">Beauty</span></strong><br />
