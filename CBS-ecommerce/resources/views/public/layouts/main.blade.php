...
<body>
    <nav class="navbar navbar-fixed-top navbar-inverse">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><strong><span class="white">Chris's</span><span class="red">Beauty</span></strong></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="{{ ( Route::getCurrentRoute()->getPath() === 'shop' ) ? 'active' : NULL }}">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="/shop">Hair Extension</a></li>
                            <li><a href="/shop">Old School Stuff</a></li>
                            <li><a href="shop/weave">Weave</a></li>
                            <li><a href="/shop">Wigs</a></li>
    ...
    <footer class="footer navbar-fixed-bottom navbar-inverse">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <p class="text-muted text-center"><strong><span class="white">Chris's</span><span class="red">Beauty</span></strong><br />
                        Copyright 2017 <a href="" target="_BLANK">MOHAMED KEITA</a></p>
                </div>
            </div>
        </div>
    </footer>
